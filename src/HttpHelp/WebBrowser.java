		...
		if(cookieStore!=null){
            ...
            for (int i = 0; i < cookies.size(); i++) {
                ...
                if ("JSESSIONID".equals(ck.getName())) {
	 				...
	 				expires = ck.getExpiryDate().toGMTString();
	 				user = ck.getValue();
			...
			Map oldCookie = BaseApplication.getInstance().getCookies();
			if(oldCookie==null)
				BaseApplication.getInstance().setCookies(cookie);
			...
			BaseApplication.getInstance().setCookie(cookiesStr);
		}
	}
...
//			{
//				JSESSIONID=cookies.getCookies().get(0).getValue(); 
//				Cookie c = cookies.getCookies().get(1);
//				path = c.getPath();
//				domain = c.getDomain();
//				if(c.getExpiryDate() != null)
//				expires = c.getExpiryDate().toGMTString();
//				user = c.getValue();
//				
//				//cookie.put("JSESSIONID",JSESSIONID);
//				cookie.put("user","\""+user+"\"");
